...
class DentistProcedureByDayOfWeekService {
  ...
  static List<DentistProcedureByDayOfWeek> _list = new List<DentistProcedureByDayOfWeek>();
  ...
  set dentistProcedureByDayOfWeek(DentistProcedureByDayOfWeek dentistProcedureByDayOfWeek) =>
  ...
  Future<List<DentistProcedureByDayOfWeek>> getAllDentistProcedureByDayOfWeekAcives() async {
    ...
    await (_dentistProcedureByDayOfWeekList = await new DentistProcedureByDayOfWeekDAO()
        .getAllDentistProcedureByDayOfWeekFilter({"dentistProcedureByDayOfWeekId": ""}, [">="]));
  ...
  Future<DentistProcedureByDayOfWeek> getOneDentistProcedureByDayOfWeekByFilter(Map filter) async {
    ...
    if (doc == null) {
      doc = (await new DentistProcedureByDayOfWeekDAO()
...
List<Map> getDentistProcedureByDayOfWeekListWithFilterFromList(Map filter) {
    ...
    if ((filter["dentistProcedureId"] != null) && (filter["dentistProcedureId"] != '')) {
      _listDocumentSnapshot.forEach((doc) {
        if (doc["dentistProcedureId"].toString() == filter["dentistProcedureId"].toString()) {
  ...
  DentistProcedureByDayOfWeek turnMapInDentistProcedureByDayOfWeek(Map map) {
    return new DentistProcedureByDayOfWeek(map["documentPath"], map["dentistProcedureId"], map["dayOfWeek"]);
  }
}