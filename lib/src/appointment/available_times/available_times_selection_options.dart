...
class AvailableTimesSelectionOptions<T> extends StringSelectionOptions<T>
    implements Selectable {
  AvailableTimesSelectionOptions(List<T> options)
      : super(options, toFilterableString: (T option) => option.toString());
  AvailableTimesSelectionOptions.withOptionGroups(
