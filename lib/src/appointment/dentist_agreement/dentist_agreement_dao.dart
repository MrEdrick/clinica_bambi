import 'dart:async';
import 'dentist_agreement_constants.dart';
import '../../firebase/firestore.dart';

class DentistAgreementDAO {
  DentistAgreementDAO();

  Future<Map<bool, String>> save(Map<String, dynamic> datas) async {
    FireStoreApp _fireStoreApp = new FireStoreApp(DENTIST_AGREEMENT_COLLECTION);
  ...
  Future<List<Map>> getAllDentistAgreementFilter(
